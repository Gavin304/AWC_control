...
static const _NavigationCommand_type_support_symbol_names_t _NavigationCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, awc_interfaces, msg, NavigationCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, awc_interfaces, msg, NavigationCommand)),
  }
};
...
{
  return &::awc_interfaces::msg::rosidl_typesupport_cpp::NavigationCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, awc_interfaces, msg, NavigationCommand)() {
  return get_message_type_support_handle<awc_interfaces::msg::NavigationCommand>();
}
