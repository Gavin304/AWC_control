...
class JoystickRos2(Node):
    ...
    def __init__(self):
        ...
        # Joy publisher
        self.publisher_ = self.create_publisher(Joy, 'joy', 10) # Added qos_profile=10
    ...
    def run(self):
        ...
        while rclpy.ok():
            ...
            try:
                ...
                print(f"Detected joystick name: '{gamepad.name}'")  # Add this line
            except IndexError:
                print('Joystick not found. Will retry every second.')
                time.sleep(1)
                device_manager._find_devices() # <--- CORRECTED
                continue
