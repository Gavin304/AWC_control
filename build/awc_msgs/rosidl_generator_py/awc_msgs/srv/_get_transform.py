...
class Metaclass_GetTransform_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('awc_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetTransform(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from awc_msgs.srv import _get_transform
...
class GetTransform(metaclass=Metaclass_GetTransform):
    from awc_msgs.srv._get_transform import GetTransform_Request as Request
    from awc_msgs.srv._get_transform import GetTransform_Response as Response
