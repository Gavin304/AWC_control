...
#include "awc_msgs/srv/detail/get_transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_awc_msgs
cdr_serialize(
  const awc_msgs::srv::GetTransform_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  awc_msgs::srv::GetTransform_Request & ros_message)
{
  // Member: frame_id
  cdr >> ros_message.frame_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = awc_msgs::srv::GetTransform_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const awc_msgs::srv::GetTransform_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<awc_msgs::srv::GetTransform_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_awc_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<awc_msgs::srv::GetTransform_Request>()
{
  return &awc_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, awc_msgs, srv, GetTransform_Request)() {
  return &awc_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_awc_msgs
cdr_serialize(
  const awc_msgs::srv::GetTransform_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: transform
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  awc_msgs::srv::GetTransform_Response & ros_message)
{
  // Member: transform
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = awc_msgs::srv::GetTransform_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const awc_msgs::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<awc_msgs::srv::GetTransform_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &awc_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, awc_msgs, srv, GetTransform_Response)() {
  return &awc_msgs::srv::typesupport_fastrtps_cpp::_GetTransform_Response__handle;
}
...
{
  return &awc_msgs::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, awc_msgs, srv, GetTransform)() {
  return &awc_msgs::srv::typesupport_fastrtps_cpp::_GetTransform__handle;
}
